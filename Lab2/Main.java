...
//lab 2
    ...
    public static void pogoda(boolean bus,boolean sun){
        if(bus!=false && sun!=false){
            System.out.println("Dostaniesz się na uczelnie");
            System.out.println("Miłego dnia i pięknej pogody");
        }
        if(sun!=true && bus!=false){
            System.out.println("Weź parasol");
            System.out.println("Dostaniesz się na uczelnie");
        }
        if(sun!=true && bus!=true) System.out.println("Nie dostaniesz się na uczelnię");
    }
    //zad 5
    public static void samochod(boolean discount,boolean bonus){
        if(discount!=false || bonus!=false){
            System.out.println("Możesz kupić samochód!");
        }else{
            System.out.println("Zakup samochód trzeba odłożyćna później...");
        }
        if(discount!=false) System.out.println("Zniżki na samochód nie ma");
    }
    //zad 6
